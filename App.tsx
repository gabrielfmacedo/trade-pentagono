...
const SYSTEM_DEFAULT_SCENARIOS: Scenario[] = [
  // ... (keeping scenarios same as provided in input)
  {
    ...
    "stackBB": 10,
    "heroBetSize": 2.5,
    "ranges": { "AA": { "ALL-IN": 100 }, "KK": { "ALL-IN": 100 }, "QQ": { "ALL-IN": 100 }, "JJ": { "ALL-IN": 100 }, "TT": { "ALL-IN": 100 }, "99": { "ALL-IN": 100 }, "88": { "ALL-IN": 100 }, "AKs": { "ALL-IN": 100 }, "AQs": { "ALL-IN": 100 }, "AJs": { "ALL-IN": 100 }, "AKo": { "ALL-IN": 100 }, "AQo": { "ALL-IN": 100 } },
